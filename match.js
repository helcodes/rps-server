class Match {
    ...
    whoWins() {
        ...
        if (this.player1.turn === "rock") {
            if (this.player2.turn === "rock") {return null}
            else if (this.player2.turn === "paper") {return this.player2}
            else if (this.player2.turn === "scissors") {return this.player1}
        } else if (this.player1.turn === "paper") {
            if (this.player2.turn === "rock") {return this.player1}
            else if (this.player2.turn === "paper") {return null}
            else if (this.player2.turn === "scissors") {return this.player2}
        } else if (this.player1.turn === "scissors") {
            if (this.player2.turn === "rock") {return this.player2}
            else if (this.player2.turn === "paper") {return this.player1}
            else if (this.player2.turn === "scissors") {return null}
        }
